...
// Hardcoded Google Apps Script URL (no environment variable needed)
const APPS_SCRIPT_URL = "https://script.google.com/a/macros/bemamusic.com/s/AKfycbwhCqywj5yX_-RXAZsnoKPEBxnAwrBOPswRfxjSkZ2d5QZtW19FpvSFVd6G23VsoqrQ/exec";
